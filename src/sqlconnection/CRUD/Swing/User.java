package sqlconnection.CRUD.Swing;
...
public class User {
    ...
    public void Connect() {
        try {
            ...
            String url = "jdbc:sqlserver://localhost:1433;databaseName=Student;user=sa;password=aayaan;encrypt=true;trustServerCertificate=true";
            String username = "sa";
